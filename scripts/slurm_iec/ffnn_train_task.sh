...
#SBATCH --job-name=IterExclTrain_v6
...
CUSTOM_PARENT_DIR="IterExcl_${DOWNDIR}_n${N}_k${K}_v6" # for organizing outputs by config
...
ACC_FILE="$ROOT_DIR/tmp/accuracies_${DOWNDIR}_n${N}_k${K}_v6/b${bcluster_num}_p${pcluster_num}.txt"
